   ...
   function totalPumpOutput_gpm  = computeTotalPumpOutputTriplexApproach1(linerSize_in, strokeLength_in, efficiency_percent, rodDiameter_in) 
   ...
   pumpType = 'DoubleActing';   % SingleActing/DoubleActing
     ...
     if (pumpType == 'SingleActing')
         ...
         totalPumpOutput_gpm(i) = 0.00010206*(linerSize_in.*linerSize_in)*strokeLength_in*efficiency_percent*totalStrokesPerMinute_spm(i);
     ...
     elseif (pumpType == 'DoubleActing')
         ...
         totalStrokesPerMinute_spm(i) = strokesPerMinute1_spm(i)+strokesPerMinute2_spm(i);
         totalPumpOutput_gpm(i) = 0.00010206*((2*(linerSize_in.*linerSize_in))-(rodDiameter_in.*rodDiameter_in))*strokeLength_in*efficiency_percent*totalStrokesPerMinute_spm(i);
