   ...
   function totalPumpOutput_gpm  = computeTotalPumpOutputApproach1(linerSize_in, strokeLength_in, efficiency_percent) 
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    efficiency_percent = 90;
     ...
     for i=1:length(blockHeight_feet)
         ...
         totalPumpOutput_gpm(i) = 0.000102*(linerSize_in.*linerSize_in)*strokeLength_in*efficiency_percent*totalStrokesPerMinute_spm(i);
     ...
     header='Block Height(feet),Flow Out(%),Hookload(klbf),Top Drive Speed(RPM),Strokes Per Minute #1,Strokes Per Minute #2,Standpipe Pressure (psi),Top Drive Torque (ftlb),Total Pump Output(gpm)'; 
